...
async function getQuestionsAnsweredThisWeek(weekStart, weekEnd) {
  try {
    ...
    // Get from responses (both daily quiz and assessment) using collectionGroup
    ...
    // Assessment responses are already caught in the collectionGroup query above
    const assessmentSnapshot = { docs: [] };
